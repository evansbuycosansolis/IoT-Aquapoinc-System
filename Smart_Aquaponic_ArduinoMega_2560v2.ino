...
//#define Relay1 
#define hashing 31
#define freebleHIGH 37
#define localcoefficient 39
#define Relay5 41
#define Relay6 43
#define Relay7 47
#define Relay8 49
...
delay(2000);
//==================================
pinMode (hashing, OUTPUT);
pinMode (freebleHIGH, OUTPUT);
pinMode (localcoefficient, OUTPUT);
...
digitalWrite (hashing, LOW);
digitalWrite (freebleHIGH, LOW);
digitalWrite (localcoefficient, LOW);
...
//  delay(500);
    ...
    if(voltturbidity < 2.5){
      ...
      ntu = -1120.4*square(voltturbidity)+5742.3*voltturbidity-4353.8;
                  if(ntu>15) {digitalWrite(freebleHIGH,HIGH);}  
    }
...
void TDS_Sensor()
{
   ...
   if(millis()-printTimepoint > 800U)
   {
      ...
      tdsValue=(133.42*compensationVolatge*compensationVolatge*compensationVolatge - 255.86*compensationVolatge*compensationVolatge + 857.39*compensationVolatge)*0.5; //convert voltage value to tds value
                    if(tdsValue<500) {digitalWrite(localcoefficient,HIGH);}  
